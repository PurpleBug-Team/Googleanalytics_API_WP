<?php 
 ...
 $returningnew = $returnother->rows[0][1];
 $returning_ = $returnother->rows[1][1];
...
<canvas height="200" width="250" id="bar-chart-horizontal"></canvas>
  <ul class="engagement-data">
    <li>
      <span class="line"></span>
        <span>Current Avg.</span>
        <span class="label-raw ng-binding">0:37</span>
        <span class="label-icon delta-positive nc-icon" ng-style="iconStyle" name="arrow-dropdown">
           <!-- ngIf: svg -->
           <i class="nc-icon-wrapper ng-binding ng-scope" ng-if="svg" ng-bind-html="svg">
              <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 16 16">
                 <g transform="translate(0, 0)">
                    <polygon fill="#444444" points="8,11.4 2.6,6 4,4.6 8,8.6 12,4.6 13.4,6 "></polygon>
                 </g>
              </svg>
           </i>
           <!-- end ngIf: svg -->
        </span>
        <span class="label-delta delta-positive">
        95%
        </span>
    </li>
    <li>
      <span class="legend-bullet past-period"></span>
...
new Chart(document.getElementById("doughnut-chart"), {
    ...
    data: {
      ...
      datasets: [
        {
          backgroundColor: ["rgba(70, 166, 231, 1)","rgba(79, 226, 135, 1)"],
...
var myChart = new Chart(ctx, {
    ...
    datasets: [
      {
        label: "TeamA Score",
        data: [<?php echo $returningnew ;?>,<?php echo $returning_;?>],
        backgroundColor: [
          "rgba(70, 166, 231, 1)",
          "rgba(79, 226, 135, 1)",
...
var myChart2 = new Chart(ctx2, {
    ...
    datasets: [
      {
        label: "TeamA Score",
        data: ['<?php echo round($averagerate[0]->rows[0][1]);?>','<?php echo round($averagerate[0]->rows[1][1]);?>'],
        backgroundColor: [
          "rgba(70, 166, 231, 1)",
          "rgba(79, 226, 135, 1)",
        ]
      ...
      {
        label: "TeamB Score",
        data: ['<?php echo round($averagerate_prev[0]->rows[0][1]);?>','<?php echo round($averagerate_prev[0]->rows[1][1]);?>'],
        backgroundColor: [
          "rgba(210, 210, 210, 1)",
          "rgba(210, 210, 210, 1)",
